...
{
    public abstract class AuthenticationServerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AuthenticationServerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AuthenticationServerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AuthenticationServerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AuthenticationServerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AuthenticationServerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AuthenticationServerDbContext, Task<T>> func)
        {
            T result;
